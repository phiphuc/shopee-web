            ...
            <div id="card" className="card" style={{ width: '100%' }}>
                ...
                <div>
                    <Modal isOpen={this.state.modal} toggle={this.toggle} className={this.props.className}>
                        ...
                        <ModalFooter>
                        {_.isEmpty(dataLogin) ?
                            <><button type="button" onClick={() => this.props.getOtp({ username: username, password: password, shopiId: data.id })} className="btn btn-solid-primary btn--s btn--inline" >Đăng nhập</button></>
