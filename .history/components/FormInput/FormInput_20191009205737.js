        ...
        return (
            <div className="header-with-search__search-section">
                <div className="shopee-searchbar">
                    ...
                    <button onClick={(linkShop) => this.props.searchShopMain(linkShop)} type="button" className="btn btn-solid-primary btn--s btn--inline" ><LogoSearch /></button>
                </div>
                <style jsx>{`
...
const mapDispatchToProps = (dispatch, ownProps) => {
    return {
        searchShopMain: (linkShop) => {
            dispatch({type:GET_MAIN_INFO_SHOP, payload: })
        }
    }
}
