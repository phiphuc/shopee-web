...
import getMainInforShop from '../../actions/index';
        ...
        return (
            <div className="header-with-search__search-section">
                <div className="shopee-searchbar">
                    ...
                    <button onClick={() => this.props.searchShopMain()} type="button" className="btn btn-solid-primary btn--s btn--inline" ><LogoSearch /></button>
                </div>
                <style jsx>{`
